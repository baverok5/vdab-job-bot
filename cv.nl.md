...
Zwijndrecht, België | +32 470 42 48 36 | baverok@gmail.com | linkedin.com/in/baverok
...
- Klantenwebsites (in teamverband): etkendanismanlik.com (consultancy) en proteinbox.com.tr (e-commerce) — blogcontent op zoekwoorden en on-page SEO om organisch verkeer te laten groeien
- majistralecza.epis.to: opbouw en onderhoud van een website voor een apothekersvereniging in WordPress/Elementor, inclusief een consistente lay-out voor ongeveer 600 ledenprofielpagina's
...
- mirook.com: een meerpaginawebsite gebouwd en geoptimaliseerd voor een Belgische jeugdschaakkampioen; JSON-LD schema (Person, SportsEvent, FAQPage), knowledge-graph-markup en een llms.txt-bestand geïmplementeerd, en iteratieve technische SEO/GEO-audits uitgevoerd die de search-health-score van de site meetbaar verhoogden
...
## Certificaten
- Semrush Academy — SEO Fundamentals (behaald, augustus 2026)
